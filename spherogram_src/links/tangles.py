...
class Tangle():
    def __init__(self, n=2, crossings=None, entry_points=None, label=None):
        ...
        These strands are numbered 0 to n-1 on the bottom,
    ...
    def __or__(self, other):
        "Put self to right of other, no fusing of strands"
        A, B = self.copy(), other.copy()
        n, m = A.n, B.n
        a, b = A.adjacent, B.adjacent
...
class ZeroTangle(Tangle):
    def __init__(self):
        ...
        Tangle.__init__(self, 2, [bot, top],
...
class InfinityTangle(Tangle):
    def __init__(self):
        ...
        Tangle.__init__(self, 2, [left, right],
